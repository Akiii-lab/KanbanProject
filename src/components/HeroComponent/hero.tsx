...
export const HeroComponent = () => {
    ...
    const fullText = "An application for managing student and group projects, from task assignment to final submission.";
            ...
            <div className="min-h-screen bg-black text-white relative overflow-hidden">
                ...
                <nav className="relative z-10 flex items-center justify-between px-6 py-4 max-w-7xl mx-auto backdrop-blur-sm">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <Link href="/register">
                            <Button 
                                className="bg-[color:var(--c-purple)] hover:bg-[color:var(--c-violet)] text-white px-6 shadow-lg hover:shadow-purple-500/25 transition-all duration-300 hover:scale-105"
                            >
                                Sign Up
                            </Button>
                        </Link>
                ...
                <div className="relative z-10 flex flex-col items-center justify-center min-h-[85vh] px-6 text-center">
                    ...
                    <div className="text-gray-300 text-lg md:text-xl max-w-3xl mb-12 leading-relaxed min-h-[4rem] flex items-center justify-center">
                        <p className="font-light">
                            {displayedText}
                            <span className="text-purple-400 inline-block cursor-blink">|</span>
                        </p>
                    </div>
